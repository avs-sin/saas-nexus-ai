...
function SlidingNumberRoller({
  ...
  // Don't render animated content until we have a height measurement
  if (!height) {
    return (
...
function SlidingNumber({
  ...
  // Measure a reference digit to get consistent height
  ...
  return (
    ...
    >
      ...
      <span
        ref={measureRef}
        aria-hidden="true"
        className="absolute opacity-0 pointer-events-none tabular-nums"
